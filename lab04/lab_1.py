...
'''
4.1 b.
P(Cavity ^ Catch) = .108 +.072  = .18
P(Catch) = .108 + .072 + .016 + .144 = .340

P(Calvity | Catch) = .18 / .34 = 0.529
P(-Cavity | Catch) = 1 - 0.529 = 0.471
'''
PC = enumerate_joint_ask('Cavity', {'Catch': T}, P)
print("The answer to 4.1 b:")
print(PC.show_approx())

# Coins
P2 = JointProbDist( ['Coin1', 'Coin2'] )
P2[T, T] = 0.25; P2[T, F] = 0.25; P2[F, T] = 0.25; P2[F, F] = 0.25
PC2 = enumerate_joint_ask('Coin2', {'Coin1': T}, P2)

print("The answer to 4.1 c:")
